...
- **Auditable disclosure.** Every secret-to-public bridge is a
  ...
  `sbom.manifest.json`). This is a PCI-relevant compliance artifact
  generated by construction, not written by hand.
...
# Regenerate the SBOM compliance artifact
capa --manifest main.capa > sbom.manifest.json
```
